...
| Collection | Purpose |
| :--- | :--- |
| **Events** | Holds all active `SchedulerAppointment` objects currently displayed on the calendar. |
| **CompletedEvents** | Stores finished tasks, allowing them to be viewed or reactivated without cluttering the active schedule. |
| **UserCategories** | Manages the list of custom categories available in the Category Manager. |
| **CategoriesForPicker** | A dropdown-friendly list of categories that automatically includes a default "No Category" fallback item. |
